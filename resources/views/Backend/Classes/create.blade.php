    ...
    <main class="app-content1 ">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header h4 text-dark">Add New Class</div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('class/store')}}">
                        @csrf
                        <div class="form-row">
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                                <label class="control-label h6">Class Name*</label>
                                <input class="form-control" type="text" name="class_name" placeholder="Enter Class Name" required>
                            </div>
                            </div>
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="class_students"  required>
                            </div>
                            </div>
                        </div>
