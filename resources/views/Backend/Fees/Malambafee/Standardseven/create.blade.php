...
<main class="app-content">
  ...
  <main class="app-content1 ">
    <div class="card">
        ...
        <div class="card-body">
          <form method="post" action="{{\Illuminate\Support\Facades\URL::to('malambafeestandardseven/store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-row"> 
            ...
            <div class="form-row"> 
              ...
              <a class="btn btn-secondary btn-lg" href="{{\Illuminate\Support\Facades\URL::to('/malambafeestandardseven')}}">Cancel</a>
