...
<main class="app-content">
  ...
  <main class="app-content1 ">
    <div class="card">
        <div class="card-header h4 text-dark text-capitalize">student Tea and lunch Fee fee payment</div>
        <div class="card-body">
          <form method="post" action="{{\Illuminate\Support\Facades\URL::to('teaandlunchfeekinderone/store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-row"> 
