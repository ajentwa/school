...
@section('title', 'Tea and Lunch Fee')
...
<main class="app-content">
  ...
  <main class="app-content1 ">
    <div class="card">
        <div class="card-header h4 text-dark text-capitalize">student tea and lunch fee payment</div>
        <div class="card-body">
          <form method="post" action="{{\Illuminate\Support\Facades\URL::to('teaandlunchfeestandardthree/store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-row"> 
