...
@section('title', 'Edit Tea and Lunch Fee')
...
<main class="app-content">
  ...
  <main class="app-content1 ">
    <div class="card">
        <div class="card-header h4 text-dark text-capitalize">edit student tea and lunch fee payment</div>
        <div class="card-body">
            <form method="post" action="{{\Illuminate\Support\Facades\URL::to('teaandlunchfeestandardthree/update/'.$fee->fee_id)}}" enctype="multipart/form-data">
            @csrf
            <div class="form-row"> 
              ...
              <div class="form-row"> 
                ...
                <input type="hidden" name="feetype_id" value="3">
                <input type="hidden" name="class_id" value="6">
                <input type="hidden" name="amount" value="25000">
                <input type="hidden" name="officer" value="{{Auth::user()->name }}">
                <a class="btn btn-secondary btn-lg" href="{{\Illuminate\Support\Facades\URL::to('/teaandlunchfeestandardthree')}}">Cancel</a>
