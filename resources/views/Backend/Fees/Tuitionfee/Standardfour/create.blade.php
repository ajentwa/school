    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <form method="post" action="{{\Illuminate\Support\Facades\URL::to('tuitionfeestandardfour/store')}}" enctype="multipart/form-data">
                @csrf
                <div class="form-row"> 
                  ...
                  <div class="form-row"> 
                    ...
                    <a class="btn btn-secondary btn-lg" href="{{\Illuminate\Support\Facades\URL::to('/tuitionfeestandardfour')}}">Cancel</a>
