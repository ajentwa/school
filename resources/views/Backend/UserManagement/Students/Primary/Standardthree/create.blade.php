            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('standardthree/store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row"> 
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="relative_phone1" placeholder="Parent Phone No1" required>
                            </div>
                            </div> 
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                                <label class="control-label h5">Parent Phone No2*</label>
                                <input class="form-control" type="number" name="relative_phone2" placeholder="Parent Phone No2" required>
                            </div>
                            </div>
                        </div>
                            <input type="hidden" name="role_id" value="4">
                            <input type="hidden" name="code" value="1234">
                            <input type="hidden" name="class_name" value="Standard Three">
                            <input type="hidden" name="occupation" value="Student">
                            <a href="{{\Illuminate\Support\Facades\URL::to('/standardthree')}}" class="btn btn-secondary btn-lg mr-2">Cancel</a>
