...
@section('title', 'Standard Five Students')

@section('content')
<main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-users"></i> Standard Five</h1>
            </div>
    ...
    <main class="app-content1 ">
                <div class="card">
                    <div class="card-header h4 text-dark">
                        ...
                        <a class="float-right btn btn-success text-white" href="{{\Illuminate\Support\Facades\URL::to('/standardfive/create')}}"><i class="fa fa-plus"></i>Add Student</a></div>
                    <div class="card-body">
                    @if(count($users) > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="bs-component text-white h5">
                                        <div class="btn-group">
                                          <a class="btn btn-secondary" href="{{\Illuminate\Support\Facades\URL::to('/standardfive/show/'.$user->id)}}">View</a>
                                          <a class="btn btn-info" href="{{\Illuminate\Support\Facades\URL::to('/standardfive/edit/'.$user->id)}}">Edit</a>
                                          <a class="btn btn-danger" href="{{\Illuminate\Support\Facades\URL::to('/standardfive/delete/'.$user->id)}}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>  
