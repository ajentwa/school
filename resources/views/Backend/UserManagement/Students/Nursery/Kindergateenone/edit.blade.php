            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('kinderone/update/'.$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="tel" name="relative_phone1" value="{{$user->relative_phone1}}" required>
                            </div>
                            </div>
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                                <label class="control-label h5">Parent Phone No2*</label>
                                <input class="form-control" type="tel" name="relative_phone2" value="{{$user->relative_phone2}}" required>
                            </div>
                            </div>
                        </div> 
                            ...
                            <a href="{{\Illuminate\Support\Facades\URL::to('/kinderone')}}" class="btn btn-secondary btn-lg mr-2">Cancel</a>
