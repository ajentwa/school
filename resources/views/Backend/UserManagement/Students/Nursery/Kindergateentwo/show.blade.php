            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 border pt-2">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Sertal Code:</strong> {{$user->code}}</li>
                                ...
                                <li class="list-group-item"><strong>Date of join:</strong> {{date('d/m/Y', strtotime($user->date_of_join))}}</li>
                    ...
                    <div class="card-footer">
                        <a class="btn btn-success btn-lg" href="{{\Illuminate\Support\Facades\URL::to('/kindertwo')}}">Go back</a>
                    </div>
                </div>
            </div>
        </div>
