            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('kindertwo/store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row"> 
                            ...
                            <input type="hidden" name="class_name" value="kindergateen Two">
                            <input type="hidden" name="occupation" value="Student">
                            <a href="{{\Illuminate\Support\Facades\URL::to('/kindertwo')}}" class="btn btn-secondary btn-lg mr-2">Cancel</a>
