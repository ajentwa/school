...
@section('content')
    ...
    <main class="app-content1 ">
                <div class="card">
                    <div class="card-header h4 text-dark">Edit Profile</div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('profile/update/'.$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                                <label class="h5" for="class">Teaching Subject</label>
                        ...
                        <div class="form-row">
                            <div class="col border pt-2 px-2">
                            <div class="form-group">
                                <label class="h5" for="level">Education Level</label>
