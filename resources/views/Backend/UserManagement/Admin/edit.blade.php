...
<main class="app-content">
    ...
    <main class="app-content1 ">
                <div class="card">
                    <div class="card-header h4 text-dark">Edit Administrator Information</div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('administrator/update/'.$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-sm-8 border pt-3 px-4">
                            <div class="form-group row">
                                <label class="control-label h6 col-sm-3">Full Name*</label>
                                <input class="form-control col-sm-9" type="text" name="name" value="{{$user->name}}" required>
                            </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control col-sm-9" type="text" name="reg_number" value="{{$user->reg_number}}" required>
                            </div>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control col-sm-9" type="text" name="code" value="{{$user->code}}" required>
                            </div>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control col-sm-9" type="number" name="phone" value="{{$user->phone}}" required>
                            </div>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control col-sm-9"  type="date" name="date_of_birth" value="{{$user->date_of_birth}}" required>
                            </div>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>
