...
@section('content')
    ...
    <main class="app-content1 ">
                <div class="card">
                    <div class="card-header h4 text-dark">Add New Teacher</div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <form method="post" action="{{\Illuminate\Support\Facades\URL::to('teacher/store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
