...
@section('content')
    ...
    <main class="app-content1">
                <div class="card">
                    <div class="card-header h5 text-dark">View Officer Details</div>
                    <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4 border pt-2">
                            <h5>Officer Photo</h5><hr>
                            <p><img style="height:400px;width:400px" src="/storage/cover_image/{{$user->cover_image}}" alt="No image Found" class="img-fluid p-10"></p>
                        </div>
                        <div class="col-sm-8 border pt-2">
                            <h5>Officer Details</h5><hr>
                            <ul class="list-group">
