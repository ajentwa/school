...
class BabyclassController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Baby Class'])->paginate(10);
        return view('Backend/UserManagement/Students/Nursery/Babyclass/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Nursery/Babyclass/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/babyclass')->with('success', 'Baby Class Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Nursery/Babyclass/show')->with('user', $user);
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Nursery/Babyclass/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/babyclass')->with('success', 'Baby Class Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/babyclass')->with('success', 'Baby Class Student Successfully Deleted!');
    }
}
