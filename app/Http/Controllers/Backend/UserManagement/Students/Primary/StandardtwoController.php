...
class StandardtwoController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard Two'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardtwo/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardtwo/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardtwo')->with('success', 'Standard Two Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardtwo/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardtwo/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardtwo')->with('success', 'Standard Two Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardtwo')->with('success', 'Standard Two Student Successfully Deleted!');
    }
}
