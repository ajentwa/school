...
class StandardsevenController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard Seven'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardseven/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardseven/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardseven')->with('success', 'Standard Seven Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/standardseven/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardseven/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardseven')->with('success', 'Standard Seven Student Updated Successfully!!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardseven')->with('success', 'Standard Seven Student Deleted Successfully!!');
    }
}
