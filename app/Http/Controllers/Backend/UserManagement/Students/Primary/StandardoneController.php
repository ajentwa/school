...
class StandardoneController extends Controller
{
   /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard One'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardone/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardone/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardone')->with('success', 'Standard One Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardone/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardone/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardone')->with('success', 'Standard One Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardone')->with('success', 'Standard One Student Successfully Deleted!');
    }
}
