...
class StandardfiveController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard Five'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardfive/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardfive/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardfive')->with('success', 'Standard Five Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/standardfive/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardfive/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardfive')->with('success', 'Standard Five Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardfive')->with('success', 'Standard Five Student Successfully Deleted!');
    }
}
