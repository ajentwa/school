...
class StandardsixController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard Six'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardsix/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardsix/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardsix')->with('success', 'Standard Six Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/standardsix/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardsix/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardsix')->with('success', 'Standard Six Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardsix')->with('success', 'Standard Six Student Successfully Deleted!');
    }
}
