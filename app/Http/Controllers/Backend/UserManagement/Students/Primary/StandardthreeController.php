...
class StandardthreeController extends Controller
{
    /**
    ...
    {
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Standard Three'])->paginate(10);
        return view('Backend/UserManagement/Students/Primary/Standardthree/index', compact('users'));
    }
    ...
    {
        return view('Backend/UserManagement/Students/Primary/Standardthree/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/standardthree')->with('success', 'Standard Three Student Added Successfully!');
    }
    ...
    {
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardthree/show', compact('user'));
    }
    ...
    public function edit($id)
    {
        $classes = MyClass::all();
        $user = User::find($id);
        return view('Backend/UserManagement/Students/Primary/Standardthree/edit', compact('user', 'classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/standardthree')->with('success', 'Standard Three Student Updated Successfully!');
    ...
    public function destroy($id)
    {
        ...
        $user->delete(); 
        return redirect('/standardthree')->with('success', 'Standard Three Student Successfully Deleted!');
    }
}
