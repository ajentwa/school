...
class UniformfeekinderoneController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('Backend/Fees/Uniformfee/Kindergateenone/create', compact('users'));
    }
    ...
    {
        $fee = Fee::find($fee_id);
        return view('Backend/Fees/Uniformfee/Kindergateenone/show', compact('fee'));
    }
    ...
    public function edit($fee_id)
    {
        $fee = Fee::find($fee_id);
        $users = User::orderby('name','ASC')->where(['role_id'=>'4', 'class'=>'Kindergateen One'])->get();
        return view('Backend/Fees/Uniformfee/Kindergateenone/edit', compact('fee','users'));
    }
    ...
    public function update(Request $request, $fee_id)
    {
        ...
        return redirect('/uniformfeekinderone')->with('success', 'Uniform Fee Payment Updated Successfully!!');
    ...
    public function destroy($fee_id)
    {
        $fee = Fee::find($fee_id);
        $fee->delete(); 
        return redirect('/uniformfeekinderone')->with('success', 'Uniform Fee Payment Successfully Deleted!');
    }
}
